...
class App extends React.Component {
  render () {
    const cardWithImageContent = [
      {image: 'biometric-1.svg', imgHeight: '163', step: '1', align: 'col-lg-11 inner-card-img square-img', text: 'El reconocimiento facial funciona mediante un software alimentado por un algoritmo que está entrenado para reconocer rostros e individualizar sus rasgos faciales.'},
      ...
      {image: 'biometric-3.svg', imgHeight: '114', step: '3', align: 'col-lg-11 inner-card-img', text: 'Con la plantilla biométrica el rostro ya puede ser leído por una computadora y contrastado con una base de datos que almacene todo un conjunto de rostros.'},
      {image: 'biometric-4.svg', imgHeight: '122', step: '4', align: 'col-lg-11 offset-lg-2 inner-card-img', text: 'El software puede llevar a cabo una comparación en tiempo real con todos los rostros almacenados en esta base de datos para determinar si una persona se encuentra almacenada allí.'},
      {image: 'biometric-5.svg', imgHeight: '161', step: '5', align: 'col-lg-11 rect-img inner-card-img', text: 'La biometría es un proceso de probabilidades, por lo que una vez que el software encuentra una potencial coincidencia, arroja un porcentaje que define qué tan probable es que correspondan a la misma persona.'}
