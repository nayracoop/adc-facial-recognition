...
class App extends React.Component {
  render () {
    const cardWithImageContent = [
      { id: 0, image: 'biometric-1.svg', imgAlt: 'reconocimiento facial', imgHeight: '163', step: '1', align: 'col-lg-10 inner-card-img square-img', text: 'El reconocimiento facial funciona mediante un software alimentado por un algoritmo (una fórmula) que está entrenado para reconocer rostros e individualizar sus rasgos.'},
      ...
      { id: 2, image: 'biometric-3.svg', imgAlt: 'contraste plantilla biométrica', imgHeight: '114', step: '3', align: 'col-lg-10 inner-card-img', text: 'Con la plantilla biométrica el rostro ya puede ser leído por una computadora y contrastado con una base de datos que previamente almacenó todo un conjunto de rostros.'},
      { id: 3, image: 'biometric-4.svg', imgAlt: 'comparación en tiempo real', imgHeight: '122', step: '4', align: 'col-lg-10 offset-lg-2 inner-card-img', text: 'El software puede llevar a cabo una comparación en tiempo real con todos los rostros almacenados en esa base de datos para determinar si una persona se encuentra registrada allí.'},
      { id: 4, image: 'biometric-5.svg', imgAlt: 'probabilidades de coincidencia', imgHeight: '161', step: '5', align: 'col-lg-10 rect-img inner-card-img', text: 'La biometría es un proceso de probabilidades, por lo que una vez que el software encuentra una potencial coincidencia, arroja un porcentaje que define qué tan probable es que corresponda a la misma persona.'}
