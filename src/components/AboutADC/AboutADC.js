      ...
      <Container fluid>
        <Row className='img-wrapper'>
          ...
          <Col lg={12} className='adc-share text-center' >
            ...
            <div class='d-flex justify-content-around share-cont m-auto'>
              {props.shareIcons}
            </div>
          </Col>
        </Row>
        <Row className='desc-wrapper'>
          <Col lg={{ span: 6, offset: 3 }} className='text-center'>
            <h2 class='pb-4'>¿Qué está haciendo la ADC?</h2>
          ...
          <Col lg={12} className='adc-social text-center' >
            ...
            <div class='d-flex justify-content-around social-cont m-auto'>
              {props.socialList}
            </div>
          </Col>
        </Row>
